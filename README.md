...
## Camera Computer
Currently the camera computer is implemented on a Raspberry PI. A server on this computer listens for a button press from a button attached to the PI's GPIO or for a mouse click from a webpage this server serves.
### Dependencies
